    ...
    <main class="dashboard-home">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div id="resources-url" class="hide">{{ route('dashboard.widget.resources') }}</div>
                    <div class="panel panel-default panel-status">
                        <div class="panel-body">
                            CPU
                            <div class="progress-group">
                                ...
                                <div class="progress">
                                    <div class="progress-bar" id="cpu-bar" role="progressbar" aria-valuenow="{{ $resources['average']['cpu'] }}" aria-valuemin="0" aria-valuemax="100" style="width: {{ $resources['average']['cpu'] }}%;">
                    ...
                    <div class="panel panel-default panel-status">
                        <div class="panel-body">
                            ...
                            <div class="progress-group">
                                ...
                                <div class="progress">
                                    <div class="progress-bar" id="memory-bar" role="progressbar" aria-valuenow="{{ $resources['average']['memory'] }}" aria-valuemin="0" aria-valuemax="100" style="width: {{ $resources['average']['memory'] }}%;">
